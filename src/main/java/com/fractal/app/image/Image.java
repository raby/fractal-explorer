...
/**
 * This class a models an image and provides functionality for writing JPEG
 * image files.
 *
 * @author  Eddie Allen
 *
...
public class Image {
    ...
    /** 
     * Constructs a new <code>Image</code> with a default width, 
     * height, and id number.
     */
    public Image() {
    ...
    /** 
     * Constructs a new <code>Image</code> with the specified width, 
     * height, and default id number.
     *
    ...
    /**
     * Constructs a new <code>Image</code> from the specified byte array and 
     * id number.
     *
    ...
    /**
     * Returns the byte array representation of this image.  This method
     * provides adds functionality for serializing an <code>Image</code>
     * across a network.
     *
    ...
    /**
     * Returns the <code>BufferedImage</code> associated with this image.
     *
     * @return The <code>BufferedImage</code> associated with this image.
     */
