package com.fractal.app.gui.settings;

import java.math.BigDecimal;
import java.util.List;
import java.util.ArrayList;
import com.fractal.app.logic.algorithms.math.ComplexNumber;
import com.fractal.app.logic.algorithms.math.Region;
import com.fractal.app.gui.shape.producer.NullShapeProducer;
import com.fractal.app.gui.shape.producer.ShapeProducer;
import com.fractal.app.gui.shape.producer.SquareProducer;

/**
 * This class encapsulates the knowledge for accessing and mutating the
 * "Fractal Explorer" application settings.  This class uses the singleton
 * design patter to ensure that only one instance of the settings is ever
 * created, allowing uniform access throughout the graphical user interface.
 *
 * @author  Eddie Allen
 *
...
public class Settings {
    ...
    /** The current producer for the <code>DrawPanel</code>.  For zooming. */
    ...
    /**
     * Creates a new <code>Settings</code> object for maintaining the 
     * settings associated with the "Fractal Explorer" application.  
     * The private constructor ensures that only a single instance of 
     * this class is created, i.e. it follows the singleton design pattern.
     */
    private Settings() {
    ...
    /**
     * Returns the selected <code>ColoringAlgorithm</code> choice.
     *
     * @return The selected <code>ColoringAlgorithm</code> choice.
     */
     ...
     *
     * @param precisionBits The new number of bits to use for performing
    ...
    /**
     * Returns the <code>Region</code> associated with the current settings.
     *
     * @return the <code>Region</code> associated with the current settings.
     */
    public Region getRegion() {
        return new Region(min, max, julia, width, height, maxIt, power, 0, 0, 0, colorAlg, precisionBits, precision);
    }

    /**
     * Returns the current <code>Producer</code> for the <code>DrawPanel</code>.
     *
     * @return The current <code>Producer</code> for the <code>DrawPanel</code>.
     */
    ...
    /**
     * Sets the new <code>Producer</code> for the <code>DrawPanel</code>.
     *
     * @param The new <code>Producer</code> for the <code>DrawPanel</code>.
     */
    ...
    /**
     * Adds the specified <code>StateChangeListener</code> to the list of 
     * listeners.
     *
     * @param listener The <code>StateChangeListener</code> to add. 
     */
    ...
    /**
     * Removes the specified <code>StateChangeListener</code> from the list of 
     * listeners.
     *
     * @param listener The <code>StateChangeListener</code> to remove.
     */
    ...
    /**
     * Adds the specified <code>ZoomListener</code> to the list of 
     * listeners.
     *
     * @param listener The <code>ZoomListener</code> to add. 
     */
    ...
    /**
     * Removes the specified <code>ZoomListener</code> from the list of 
     * listeners.
     *
     * @param listener The <code>ZoomListener</code> to remove.
     */
