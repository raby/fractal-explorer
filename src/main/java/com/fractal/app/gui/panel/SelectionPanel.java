...
import edu.wcu.cs.cs495.team1.capstone.gui.shape.producer.NullShapeProducer;
import edu.wcu.cs.cs495.team1.capstone.gui.shape.producer.SquareProducer;

/**
 * This panel encapsulates the knowledge for making the various selections
 * for changing the application settings for the "Fractal Explorer".
 *
 * @author  Eddie Allen
 *
...
public class SelectionPanel extends JPanel {
    ...
    /** 
     * Returns the panel containing the radio buttons for changing the 
     * application settings.
     *
     * @return The panel containing the radio buttons for changing the 
     *         application settings.
     */
    ...
    /** 
     * Returns the panel containing the buttons for changing the application
     * settings.
     *
     * @return The panel containing the buttons for changing the application
     *         settings.
     */
    private JPanel createButtonPanel() {
        ...
        TitledBorder title = null;
        Border line = BorderFactory.createLineBorder(Color.BLACK);
        String[] items = { "SW 4-Body", "Star Wheel", "Clockwise Spiral", "NW Spire", "Towers & 3 Spirals",
                "Mini Mandelbrot" };

        regionComboBox = new JComboBox(items);
    ...
    /** 
     * Returns the panel containing the check boxes for enabling and disabling
     * smooth coloring and precision calculations.
     *
     * @return The panel containing the check boxes for enabling and disabling
     *         smooth coloring and precision calculations.
     */
    private JPanel createCheckBoxPanel() {
        ...
        String[] eqnItems = { "z^2 + c", "z^3 + c", "z^4 + c", "z^5 + c", "z^6 + c", "z^7 + c", "z^8 + c", "z^9 + c",
                "z^10 + c" };
        ...
        sizeComboBox = new JComboBox(sizeItems);
        eqnComboBox = new JComboBox(eqnItems);
        precisionComboBox = new JComboBox(bitItems);
    ...
    /** 
     * Returns the dialog panel for specifying the maximum number of 
     * iterations to perform.
     *
     * @return The dialog panel for specifying the maximum number of 
     *         iterations to perform.
     */
    ...
    /** 
     * Returns the dialog panel for entering a specific Mandelbrot region 
     * to view.
     *
     * @return The dialog panel for entering a specific Mandelbrot region 
     *         to view.
     */
    ...
    private void getRegionInput() {
        try {
            ...
            dialog.setVisible(false);
            System.out.println("Min is: " + settings.getMin().toString() + " Max is: " + settings.getMax().toString());
        } catch (NumberFormatException nfe) {
            System.out.println(nfe.getMessage());
        }
    }
    ...
    private void createSizeComboBoxListener() {
        sizeComboBox.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                System.out.println("Height is: " + settings.getHeight() + " Width is: " + settings.getWidth());
            }
        });
    }
