...
import edu.wcu.cs.cs495.team1.capstone.gui.shape.producer.ShapeCreationListener;
import edu.wcu.cs.cs495.team1.capstone.gui.shape.producer.SquareProducer;
import edu.wcu.cs.cs495.team1.capstone.gui.shape.producer.ShapeProducer;
import edu.wcu.cs.cs495.team1.capstone.algorithms.math.ComplexNumber;

/**
 * This class models the panel on which Mandelbrot and Julia sets will be 
 * displayed. 
 *
 * @author Russell T. Gaskey 
 *
...
public class DrawPanel extends JPanel
    ...
    public DrawPanel() {
        canvas = new BufferedImage(settings.getWidth(), settings.getHeight(), BufferedImage.TYPE_INT_RGB);
    ...
    /**
     * Repaints the current shape in progress to the <code>DrawPanel</code>.
     *
    ...
    /** Resizes the canvas and <code>DrawPanel</code> upon state change. */
    ...
    /**
     * Repaints the <code>DrawPanel</code> to reflect any changes made to 
     * the canvas.
     *
