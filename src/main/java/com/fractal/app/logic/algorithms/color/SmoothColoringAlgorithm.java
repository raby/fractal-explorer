...
public class SmoothColoringAlgorithm implements ColoringAlgorithm {
    ...
    /**
     * Creates a new <code>SmoothColoringAlgorithm</code> and initializes the
    ...
    public SmoothColoringAlgorithm(int maxIt, int colorRange) {
        ...
        this.colors = new int[colorRange];
    ...
    /** 
     * Gets the RGB color value for a Mandelbrot point with the "escape" value
     * specified by the number of iterations taken to escape and the maximum
     * number of iterations.
     *
     * @param iterations The number of iterations taken to "escape".
    ...
    private int getMandelbrotColor(int iterations) {
        ...
        /*
         * This block of code will add color to the points in the set, 
         * but it does not do it for all of the points in the set.
         *
         *   if (Double.isNaN(mu) || Double.isInfinite(mu)) {
         *       index = colorRange - 1;
         *   }
