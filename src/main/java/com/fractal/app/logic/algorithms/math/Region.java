...
/**
 * This class models a <code>Region</code> in the Complex Plane.
 *
 * @author  Eddie Allen
 *
...
public class Region {
    ...
    private static final long serialVersionUID = -8612455771680843870l;
     ...
     */
    public Region(ComplexNumber min, ComplexNumber max, ComplexNumber julia, int width, int height, int maxIt,
            int power, int id, int x, int y, int colorAlg, int precisionBits, boolean precision) {
        this.min = min;
        this.max = max;
        this.julia = julia;
        this.width = width;
    ...
    /**
     * Returns the selection for the <code>ColoringAlgorithm</code>.
     *
     * @return The selection for the <code>ColoringAlgorithm</code>.
     */
